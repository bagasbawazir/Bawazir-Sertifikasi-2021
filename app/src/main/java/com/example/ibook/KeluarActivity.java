...
public class KeluarActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kalendar = findViewById(R.id.logo_keluar);
        tgl = findViewById(R.id.tgl_keluar);
        nominal = findViewById(R.id.nominal_keluar);
        ket = findViewById(R.id.keterangan_keluar);
        simpan = findViewById(R.id.penyimpanan_keluar);
        ...
        kalendar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new DatePickerDialog(KeluarActivity.this, date, myCalendar
